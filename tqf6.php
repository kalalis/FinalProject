...
<body>
    ...
    <?php include 'tabbar.php' ?>
     ...
     <br>
    <h3 style="margin-left: 400px; color: black; font-size: 30px;">มคอ.6</h3>
    ...
    <div class="content">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#fileModal">Download</a></li> 
                <li><a class="dropdown-item " href="#">Print</a></li>
                <!-- <li><a class="dropdown-item" href="tqf6Delete.php?crsNo=<?php echo $row['crsNo'] ?>">DELETE</a></li> -->
            </ul>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header" >
                                <h5 class="modal-title" id="exampleModalLabel">เอกสาร มคอ.6</h5>
            ...
            <table class="table table-striped  table-hover table-responsive table-bordered">
                <tbody>
                    <?php
                        ...
                        $stmt = $conn->prepare("SELECT * FROM tqf6 WHERE tqf6.crs_no='204390'");
                        $stmt->execute();
                    ...
                    <tr>
                        <div class="file-query">
                            <li><a href="docs/tqf4/<?php echo $row['doc_file'];?>" target="_blank" 
...
if (isset($_POST['doc_name'])) {
    ...
    //sql insert
    $stmt = $conn->prepare("INSERT INTO tqf6 (doc_name, doc_file, crs_no)
        ...
        if($result){
            echo '<script>
                ...
                swal({
                    ...
                    window.location = "tqf6.php"; //หน้าที่ต้องการให้กระโดดไป
                });
                }, 1000);
            </script>';
        }else{
