    ...
    <div class="content">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item" href="tqf4Delete.php?crsNo=<?php echo $row['crsNo'] ?>">DELETE</a></li>
            </ul>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header" >
                                <h5 class="modal-title" id="exampleModalLabel">เอกสาร มคอ.4</h5>
            ...
            <table class="table table-striped  table-hover table-responsive table-bordered">
                <tbody>
                    <?php
                        ...
                        require_once 'config/db.php';
                        $crsNo = $_GET['crsNo'];
                        $stmt = $conn->prepare("SELECT * FROM tqf4 WHERE tqf4.crs_no='204390'");
                        $stmt->execute();
...
if (isset($_POST['doc_name'])) {
    ...
    //sql insert
    $stmt = $conn->prepare("INSERT INTO tqf4 (doc_name, doc_file, crs_no)
        ...
        if($result){
            echo '<script>
                ...
                swal({
                    ...
                    window.location = "tqf4.php"; //หน้าที่ต้องการให้กระโดดไป
                });
                }, 1000);
            </script>';
        }else{
