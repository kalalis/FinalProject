...
<?php  
    if (isset($_GET['delete'])) {
        ...
        $deletestmt = $conn->query("DELETE FROM crit WHERE no = $delete_no");
        $deletestmt->execute();

        if ($deletestmt) {
            echo "<script>alert('Data has been deleted successfully');</script>";
            $_SESSION['success'] = "Data has been deleted succesfully";
            header("refresh:1; url=critDelete.php");
        }
...
<body>
    ...
    <div class="content">
        ...
        <br>
        <a class="btn btn-primary" href="crit.php" role="button" style="margin-left: 40%;">Back</a>
