...
<body>
    ...
    <?php include 'tabbar.php' ?>
     ...
     <br>
    <h3 style="margin-left: 400px; color: black; font-size: 30px;">มคอ.3</h3>
    ...
    <div class="content">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item disabled" href="tqf3Edit.php?crsNo=<?php echo $row['crsNo'] ?>">EDIT</a></li>
                <li><a class="dropdown-item" href="tqf3Delete.php?crsNo=<?php echo $row['crsNo'] ?>">DELETE</a></li>
            </ul>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header" >
                                <h5 class="modal-title" id="exampleModalLabel">เอกสาร มคอ.3</h5>
                ...
                <tbody>
                    ...
                    <tr>
                        <div class="file-query">
                            <li><a href="docs/tqf3/<?php echo $row['doc_file'];?>" target="_blank" 
...
if (isset($_POST['doc_name'])) {
    ...
    //sql insert
    $stmt = $conn->prepare("INSERT INTO tqf3 (doc_name, doc_file, crs_no)
