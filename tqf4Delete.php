...
<?php  
    if (isset($_GET['delete'])) {
        ...
        $deletestmt = $conn->query("DELETE FROM tqf4 WHERE no = $delete_no");
        $deletestmt->execute();
...
<body>
    ...
    <?php include 'tabbar.php' ?>
     ...
     <br>
    <h3 style="margin-left: 400px; ">มคอ.4</h3>
    ...
    <div class="content">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header" >
                                <h5 class="modal-title" id="exampleModalLabel">Add File TQF4</h5>
            ...
            <table class="table table-striped  table-hover table-responsive table-bordered">
                ...
                <tbody>
                    <?php
                        ...
                        require_once 'config/db.php';
                        $crsNo = $_GET['crsNo'];
                        $stmt = $conn->prepare("SELECT * FROM tqf4 WHERE tqf4.crs_no=$crsNo");
                        $stmt->execute();
                    ...
                    <tr>
                        <td><?= $row['doc_name'];?></td>
                        <td><a href="docs/tqf4/<?php echo $row['doc_file'];?>" target="_blank" class="btn btn-info btn-sm"> เปิดดู </a></td>
                        <td>
        ...
        <br>
        <a class="btn btn-primary" href="tqf4.php?crsNo=<?php echo $crsNo ?>" role="button" style="margin-left: 40%;">Back</a>
