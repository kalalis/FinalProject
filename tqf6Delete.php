...
<?php  
    if (isset($_GET['delete'])) {
        ...
        $deletestmt = $conn->query("DELETE FROM tqf6 WHERE no = $delete_no");
        $deletestmt->execute();

        if ($deletestmt) {
            echo "<script>alert('Data has been deleted successfully');</script>";
            $_SESSION['success'] = "Data has been deleted succesfully";
            header("refresh:1; url=tqf4Delete.php");
        }
...
<body>
    ...
    <?php include 'tabbar.php' ?>
     ...
     <br>
    <h3 style="margin-left: 400px; ">มคอ.6</h3>
    ...
    <div class="content">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header" >
                                <h5 class="modal-title" id="exampleModalLabel">Add File TQF6</h5>
        ...
        <h3 style="margin-left: 20px;">รายการเอกสาร </h3> <br>
            <table class="table table-striped  table-hover table-responsive table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $row['doc_name'];?></td>
                        <td><a href="docs/tqf6/<?php echo $row['doc_file'];?>" target="_blank" class="btn btn-info btn-sm"> เปิดดู </a></td>
                        <td>
        ...
        <br>
        <a class="btn btn-primary" href="tqf6.php?crsNo=<?php echo $crsNo ?>" role="button" style="margin-left: 40%;">Back</a>
